//    
    var fin = 241500;                                 //fin del video
    var delay = 2300;                                 //delay para comenzar el video
    var inicio = 0;                                   //inicio del video
    var BPM = 57;                                     //beats por minutos
    var starthud = 4700;                              //aparicion del hud
    var numcoachs = "1";                              //números de coach 1 / 2 / 3-4
